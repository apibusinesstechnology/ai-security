...
import { UpdateUserIdentityProvidersRequest } from "../models/UpdateUserIdentityProvidersRequest";
...
import { UserOverrideIdentityProvidersResponse } from "../models/UserOverrideIdentityProvidersResponse";
...
export declare class UsersApiRequestFactory extends BaseAPIRequestFactory {
    ...
    getUserIdentityProviders(userId: string, _options?: Configuration): Promise<RequestContext>;
    ...
    updateUserIdentityProviders(userId: string, body: UpdateUserIdentityProvidersRequest, _options?: Configuration): Promise<RequestContext>;
}
export declare class UsersApiResponseProcessor {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    getUserIdentityProviders(response: ResponseContext): Promise<UserOverrideIdentityProvidersResponse>;
    /**
     * Unwraps the actual response sent by the server from the response context and deserializes the response content
     * to the expected objects
     *
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    updateUserIdentityProviders(response: ResponseContext): Promise<void>;
}
...
export interface UsersApiGetUserIdentityProvidersRequest {
    /**
     * The ID of the user.
     * @type string
     */
...
export interface UsersApiUpdateUserIdentityProvidersRequest {
    /**
     * The ID of the user.
     * @type string
     */
...
export declare class UsersApi {
     ...
     * @param param The request object
     */
    getUserIdentityProviders(param: UsersApiGetUserIdentityProvidersRequest, options?: Configuration): Promise<UserOverrideIdentityProvidersResponse>;
    /**
     ...
     * @param param The request object
     */
    updateUserIdentityProviders(param: UsersApiUpdateUserIdentityProvidersRequest, options?: Configuration): Promise<void>;
}
