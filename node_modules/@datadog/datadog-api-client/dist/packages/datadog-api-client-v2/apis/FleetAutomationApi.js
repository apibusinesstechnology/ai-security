...
class FleetAutomationApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    cancelFleetDeploymentV2(deploymentId, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (deploymentId === null || deploymentId === undefined) {
                throw new baseapi_1.RequiredError("deploymentId", "cancelFleetDeploymentV2");
            }
            // Path Params
            const localVarPath = "/api/v2/fleet/deployments/{deployment_id}/cancel".replace("{deployment_id}", encodeURIComponent(String(deploymentId)));
    ...
    createFleetDeploymentConfigureV2(body, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new baseapi_1.RequiredError("body", "createFleetDeploymentConfigureV2");
            }
            // Path Params
            ...
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(body, "FleetDeploymentConfigureV2CreateRequest", ""), contentType);
    ...
    createFleetDeploymentUpgradeV2(body, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new baseapi_1.RequiredError("body", "createFleetDeploymentUpgradeV2");
            }
            // Path Params
            ...
            requestContext.setHeaderParam("Content-Type", contentType);
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(body, "FleetDeploymentPackageUpgradeV2CreateRequest", ""), contentType);
            requestContext.setBody(serializedBody);
            // Apply auth methods
            (0, configuration_1.applySecurityAuthentication)(_config, requestContext, [
                "apiKeyAuth",
    ...
    getFleetAgentDetailV2(agentKey, include, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // verify required parameter 'agentKey' is not null or undefined
            if (agentKey === null || agentKey === undefined) {
                throw new baseapi_1.RequiredError("agentKey", "getFleetAgentDetailV2");
            }
            // Path Params
            const localVarPath = "/api/v2/fleet/agents/{agent_key}".replace("{agent_key}", encodeURIComponent(String(agentKey)));
            // Make Request Context
            const requestContext = _config
    ...
    getFleetDeploymentV2(deploymentId, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // verify required parameter 'deploymentId' is not null or undefined
            if (deploymentId === null || deploymentId === undefined) {
                throw new baseapi_1.RequiredError("deploymentId", "getFleetDeploymentV2");
            }
            // Path Params
            const localVarPath = "/api/v2/fleet/deployments/{deployment_id}".replace("{deployment_id}", encodeURIComponent(String(deploymentId)));
            // Make Request Context
            const requestContext = _config
    ...
    getFleetScheduleV2(id, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new baseapi_1.RequiredError("id", "getFleetScheduleV2");
            }
            // Path Params
            const localVarPath = "/api/v2/fleet/schedules/{id}".replace("{id}", encodeURIComponent(String(id)));
            // Make Request Context
            const requestContext = _config
    ...
    listFleetAgentsV2(pageNumber, pageSize, filter, tags, sortAttribute, sortDescending, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // Path Params
    ...
    listFleetAgentTracers(agentKey, pageNumber, pageSize, sortAttribute, sortDescending, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            logger_1.logger.warn("Using unstable operation 'listFleetAgentTracers'");
            ...
            // verify required parameter 'agentKey' is not null or undefined
            if (agentKey === null || agentKey === undefined) {
                throw new baseapi_1.RequiredError("agentKey", "listFleetAgentTracers");
            }
            // Path Params
            const localVarPath = "/api/unstable/fleet/agents/{agent_key}/tracers".replace("{agent_key}", encodeURIComponent(String(agentKey)));
            // Make Request Context
            const requestContext = _config
    ...
    listFleetAgentVersionsV2(_options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // Path Params
    ...
    listFleetDeploymentsV2(pageSize, pageNumber, sort, ascending, filter, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // Path Params
            ...
            if (ascending !== undefined) {
                requestContext.setQueryParam("ascending", ObjectSerializer_1.ObjectSerializer.serialize(ascending, "boolean", ""), "");
            }
            if (filter !== undefined) {
                requestContext.setQueryParam("filter", ObjectSerializer_1.ObjectSerializer.serialize(filter, "string", ""), "");
            }
    ...
    listFleetTracers(pageNumber, pageSize, sortAttribute, sortDescending, filter, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            logger_1.logger.warn("Using unstable operation 'listFleetTracers'");
...
class FleetAutomationApiResponseProcessor {
     ...
     */
    cancelFleetDeploymentV2(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "FleetDeploymentV2CancelResponse");
                return body;
            }
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    createFleetDeploymentConfigureV2(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "FleetDeploymentConfigureV2DryRunResponse");
                return body;
            }
            if (response.httpStatusCode === 201) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "FleetDeploymentV2CreateResponse");
                return body;
            }
            if (response.httpStatusCode === 400 ||
                response.httpStatusCode === 401 ||
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    createFleetDeploymentUpgradeV2(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 201) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "FleetDeploymentV2CreateResponse");
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    getFleetAgentDetailV2(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "FleetAgentDetailV2Response");
                return body;
            }
            if (response.httpStatusCode === 400 ||
                response.httpStatusCode === 401 ||
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    getFleetDeploymentV2(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "FleetDeploymentV2DetailResponse");
                return body;
            }
            if (response.httpStatusCode === 400 ||
                response.httpStatusCode === 401 ||
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    getFleetScheduleV2(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "FleetScheduleV2Response");
                return body;
            }
            if (response.httpStatusCode === 400 ||
                response.httpStatusCode === 401 ||
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    listFleetAgentsV2(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "FleetAgentsV2Response");
                return body;
            }
            if (response.httpStatusCode === 400 ||
                response.httpStatusCode === 401 ||
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    listFleetAgentTracers(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "FleetTracersResponse");
                return body;
            }
            if (response.httpStatusCode === 400 ||
                response.httpStatusCode === 401 ||
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    listFleetAgentVersionsV2(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "FleetAgentVersionsV2Response");
                return body;
            }
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    listFleetDeploymentsV2(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "FleetDeploymentsV2Response");
                return body;
            }
            if (response.httpStatusCode === 400 ||
                response.httpStatusCode === 401 ||
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    listFleetSchedulesV2(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "FleetSchedulesV2Response");
                return body;
            }
            if (response.httpStatusCode === 400 ||
                response.httpStatusCode === 401 ||
...
class FleetAutomationApi {
     ...
     */
    cancelFleetDeploymentV2(param, options) {
        const requestContextPromise = this.requestFactory.cancelFleetDeploymentV2(param.deploymentId, options);
        return requestContextPromise.then((requestContext) => {
            return this.configuration.httpApi
                .send(requestContext)
                .then((responseContext) => {
                return this.responseProcessor.cancelFleetDeploymentV2(responseContext);
            });
        });
    }
    /**
     ...
     * @param param The request object
     */
    createFleetDeploymentConfigureV2(param, options) {
        const requestContextPromise = this.requestFactory.createFleetDeploymentConfigureV2(param.body, options);
        return requestContextPromise.then((requestContext) => {
            return this.configuration.httpApi
                .send(requestContext)
                .then((responseContext) => {
                return this.responseProcessor.createFleetDeploymentConfigureV2(responseContext);
            });
        });
    }
    /**
     ...
     * @param param The request object
     */
    createFleetDeploymentUpgradeV2(param, options) {
        const requestContextPromise = this.requestFactory.createFleetDeploymentUpgradeV2(param.body, options);
        return requestContextPromise.then((requestContext) => {
            return this.configuration.httpApi
                .send(requestContext)
                .then((responseContext) => {
                return this.responseProcessor.createFleetDeploymentUpgradeV2(responseContext);
            });
        });
    }
    /**
     ...
     * @param param The request object
     */
    getFleetAgentDetailV2(param, options) {
        const requestContextPromise = this.requestFactory.getFleetAgentDetailV2(param.agentKey, param.include, options);
        return requestContextPromise.then((requestContext) => {
            return this.configuration.httpApi
                .send(requestContext)
                .then((responseContext) => {
     ...
     * @param param The request object
     */
    getFleetDeploymentV2(param, options) {
        const requestContextPromise = this.requestFactory.getFleetDeploymentV2(param.deploymentId, options);
        return requestContextPromise.then((requestContext) => {
            return this.configuration.httpApi
                .send(requestContext)
                .then((responseContext) => {
     ...
     * @param param The request object
     */
    getFleetScheduleV2(param, options) {
        const requestContextPromise = this.requestFactory.getFleetScheduleV2(param.id, options);
        return requestContextPromise.then((requestContext) => {
            return this.configuration.httpApi
                .send(requestContext)
                .then((responseContext) => {
     ...
     * @param param The request object
     */
    listFleetAgentsV2(param = {}, options) {
        const requestContextPromise = this.requestFactory.listFleetAgentsV2(param.pageNumber, param.pageSize, param.filter, param.tags, param.sortAttribute, param.sortDescending, options);
        return requestContextPromise.then((requestContext) => {
            return this.configuration.httpApi
                .send(requestContext)
                .then((responseContext) => {
     ...
     * @param param The request object
     */
    listFleetAgentTracers(param, options) {
        const requestContextPromise = this.requestFactory.listFleetAgentTracers(param.agentKey, param.pageNumber, param.pageSize, param.sortAttribute, param.sortDescending, options);
        return requestContextPromise.then((requestContext) => {
            return this.configuration.httpApi
                .send(requestContext)
                .then((responseContext) => {
     ...
     * @param param The request object
     */
    listFleetAgentVersionsV2(options) {
        const requestContextPromise = this.requestFactory.listFleetAgentVersionsV2(options);
        return requestContextPromise.then((requestContext) => {
            return this.configuration.httpApi
                .send(requestContext)
                .then((responseContext) => {
                return this.responseProcessor.listFleetAgentVersionsV2(responseContext);
            });
        });
    }
    /**
     ...
     * @param param The request object
     */
    listFleetDeploymentsV2(param = {}, options) {
        const requestContextPromise = this.requestFactory.listFleetDeploymentsV2(param.pageSize, param.pageNumber, param.sort, param.ascending, param.filter, options);
        return requestContextPromise.then((requestContext) => {
            return this.configuration.httpApi
                .send(requestContext)
                .then((responseContext) => {
    ...
    listFleetSchedulesV2(options) {
        const requestContextPromise = this.requestFactory.listFleetSchedulesV2(options);
        return requestContextPromise.then((requestContext) => {
            return this.configuration.httpApi
                .send(requestContext)
                .then((responseContext) => {
     ...
     * @param param The request object
     */
    listFleetTracers(param = {}, options) {
        const requestContextPromise = this.requestFactory.listFleetTracers(param.pageNumber, param.pageSize, param.sortAttribute, param.sortDescending, param.filter, options);
        return requestContextPromise.then((requestContext) => {
            return this.configuration.httpApi
                .send(requestContext)
                .then((responseContext) => {
