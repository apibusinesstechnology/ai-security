...
class TagPoliciesApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    ...
    deleteTagPolicy(policyId, hardDelete, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // Path Params
            const localVarPath = "/api/v2/tag_policies/{policy_id}".replace("{policy_id}", encodeURIComponent(String(policyId)));
            // Make Request Context
            const requestContext = _config
    ...
    getTagPolicyScore(policyId, tsStart, tsEnd, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // Path Params
            const localVarPath = "/api/v2/tag_policies/{policy_id}/score".replace("{policy_id}", encodeURIComponent(String(policyId)));
            // Make Request Context
            const requestContext = _config
