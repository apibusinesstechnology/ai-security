...
class MetricsApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    ...
    createHistoricalMetricsConfiguration(body, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            logger_1.logger.warn("Using unstable operation 'createHistoricalMetricsConfiguration'");
            if (!_config.unstableOperations["v2.createHistoricalMetricsConfiguration"]) {
                throw new Error("Unstable operation 'createHistoricalMetricsConfiguration' is disabled");
            }
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new baseapi_1.RequiredError("body", "createHistoricalMetricsConfiguration");
            }
            // Path Params
            ...
            requestContext.setHeaderParam("Content-Type", contentType);
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(body, "HistoricalMetricsConfigurationCreateRequest", ""), contentType);
            requestContext.setBody(serializedBody);
            // Apply auth methods
            (0, configuration_1.applySecurityAuthentication)(_config, requestContext, [
                "apiKeyAuth",
    ...
    createTagIndexingRule(body, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            logger_1.logger.warn("Using unstable operation 'createTagIndexingRule'");
            ...
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new baseapi_1.RequiredError("body", "createTagIndexingRule");
            }
            // Path Params
            ...
            requestContext.setHeaderParam("Content-Type", contentType);
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(body, "TagIndexingRuleCreateRequest", ""), contentType);
            requestContext.setBody(serializedBody);
            // Apply auth methods
            (0, configuration_1.applySecurityAuthentication)(_config, requestContext, [
                "apiKeyAuth",
    ...
    createTagIndexingRuleExemption(metricName, body, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            logger_1.logger.warn("Using unstable operation 'createTagIndexingRuleExemption'");
            ...
            // verify required parameter 'metricName' is not null or undefined
            if (metricName === null || metricName === undefined) {
                throw new baseapi_1.RequiredError("metricName", "createTagIndexingRuleExemption");
            }
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new baseapi_1.RequiredError("body", "createTagIndexingRuleExemption");
            }
            // Path Params
            const localVarPath = "/api/v2/metrics/{metric_name}/tag-indexing-rule-exemptions".replace("{metric_name}", encodeURIComponent(String(metricName)));
            // Make Request Context
            const requestContext = _config
            ...
            requestContext.setHeaderParam("Content-Type", contentType);
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(body, "TagIndexingRuleExemptionCreateRequest", ""), contentType);
            requestContext.setBody(serializedBody);
            // Apply auth methods
            (0, configuration_1.applySecurityAuthentication)(_config, requestContext, [
                "apiKeyAuth",
    ...
    deleteHistoricalMetricsConfiguration(metricName, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            logger_1.logger.warn("Using unstable operation 'deleteHistoricalMetricsConfiguration'");
            if (!_config.unstableOperations["v2.deleteHistoricalMetricsConfiguration"]) {
                throw new Error("Unstable operation 'deleteHistoricalMetricsConfiguration' is disabled");
            }
            // verify required parameter 'metricName' is not null or undefined
            if (metricName === null || metricName === undefined) {
                throw new baseapi_1.RequiredError("metricName", "deleteHistoricalMetricsConfiguration");
            }
            // Path Params
            const localVarPath = "/api/v2/metrics/historical-metrics-configurations/{metric_name}".replace("{metric_name}", encodeURIComponent(String(metricName)));
            // Make Request Context
            const requestContext = _config
    ...
    deleteTagIndexingRule(id, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            logger_1.logger.warn("Using unstable operation 'deleteTagIndexingRule'");
            ...
            if (id === null || id === undefined) {
                throw new baseapi_1.RequiredError("id", "deleteTagIndexingRule");
            }
            // Path Params
            const localVarPath = "/api/v2/metrics/tag-indexing-rules/{id}".replace("{id}", encodeURIComponent(String(id)));
            // Make Request Context
            const requestContext = _config
    ...
    deleteTagIndexingRuleExemption(metricName, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            logger_1.logger.warn("Using unstable operation 'deleteTagIndexingRuleExemption'");
            ...
            // verify required parameter 'metricName' is not null or undefined
            if (metricName === null || metricName === undefined) {
                throw new baseapi_1.RequiredError("metricName", "deleteTagIndexingRuleExemption");
            }
            // Path Params
            const localVarPath = "/api/v2/metrics/{metric_name}/tag-indexing-rule-exemptions".replace("{metric_name}", encodeURIComponent(String(metricName)));
            // Make Request Context
    ...
    getHistoricalMetricsConfiguration(metricName, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            logger_1.logger.warn("Using unstable operation 'getHistoricalMetricsConfiguration'");
            if (!_config.unstableOperations["v2.getHistoricalMetricsConfiguration"]) {
                throw new Error("Unstable operation 'getHistoricalMetricsConfiguration' is disabled");
            }
            // verify required parameter 'metricName' is not null or undefined
            if (metricName === null || metricName === undefined) {
                throw new baseapi_1.RequiredError("metricName", "getHistoricalMetricsConfiguration");
            }
            // Path Params
            const localVarPath = "/api/v2/metrics/historical-metrics-configurations/{metric_name}".replace("{metric_name}", encodeURIComponent(String(metricName)));
            // Make Request Context
    ...
    getMetricTagCardinalityDetails(metricName, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // verify required parameter 'metricName' is not null or undefined
            if (metricName === null || metricName === undefined) {
                throw new baseapi_1.RequiredError("metricName", "getMetricTagCardinalityDetails");
            }
            // Path Params
            const localVarPath = "/api/v2/metrics/{metric_name}/tag-cardinalities".replace("{metric_name}", encodeURIComponent(String(metricName)));
            // Make Request Context
            const requestContext = _config
    ...
    getTagIndexingRule(id, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            logger_1.logger.warn("Using unstable operation 'getTagIndexingRule'");
            if (!_config.unstableOperations["v2.getTagIndexingRule"]) {
                throw new Error("Unstable operation 'getTagIndexingRule' is disabled");
            }
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new baseapi_1.RequiredError("id", "getTagIndexingRule");
            }
            // Path Params
            const localVarPath = "/api/v2/metrics/tag-indexing-rules/{id}".replace("{id}", encodeURIComponent(String(id)));
            // Make Request Context
    ...
    getTagIndexingRuleExemption(metricName, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            logger_1.logger.warn("Using unstable operation 'getTagIndexingRuleExemption'");
            ...
            // verify required parameter 'metricName' is not null or undefined
            if (metricName === null || metricName === undefined) {
                throw new baseapi_1.RequiredError("metricName", "getTagIndexingRuleExemption");
            }
            // Path Params
            const localVarPath = "/api/v2/metrics/{metric_name}/tag-indexing-rule-exemptions".replace("{metric_name}", encodeURIComponent(String(metricName)));
            // Make Request Context
    ...
    listTagConfigurations(filterConfigured, filterIsConfigurable, filterTagsConfigured, filterMetricType, filterIncludePercentiles, filterQueried, filterQueriedWindowSeconds, filterTags, filterRelatedAssets, include, sort, windowSeconds, pageSize, pageCursor, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // Path Params
            ...
            if (filterIsConfigurable !== undefined) {
                requestContext.setQueryParam("filter[is_configurable]", ObjectSerializer_1.ObjectSerializer.serialize(filterIsConfigurable, "boolean", ""), "");
            }
            ...
            if (filterQueriedWindowSeconds !== undefined) {
                requestContext.setQueryParam("filter[queried][window][seconds]", ObjectSerializer_1.ObjectSerializer.serialize(filterQueriedWindowSeconds, "number", "int64"), "");
            }
    ...
    listTagIndexingRules(pageLimit, pageOffset, search, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            logger_1.logger.warn("Using unstable operation 'listTagIndexingRules'");
    ...
    listTagIndexingRulesForMetric(metricName, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            logger_1.logger.warn("Using unstable operation 'listTagIndexingRulesForMetric'");
            ...
            // verify required parameter 'metricName' is not null or undefined
            if (metricName === null || metricName === undefined) {
                throw new baseapi_1.RequiredError("metricName", "listTagIndexingRulesForMetric");
            }
            // Path Params
            const localVarPath = "/api/v2/metrics/{metric_name}/tag-indexing-rules".replace("{metric_name}", encodeURIComponent(String(metricName)));
            // Make Request Context
            const requestContext = _config
    ...
    listTagsByMetricName(metricName, windowSeconds, filterTags, filterMatch, filterIncludeTagValues, filterAllowPartial, pageLimit, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // verify required parameter 'metricName' is not null or undefined
            if (metricName === null || metricName === undefined) {
            ...
            if (filterIncludeTagValues !== undefined) {
                requestContext.setQueryParam("filter[include_tag_values]", ObjectSerializer_1.ObjectSerializer.serialize(filterIncludeTagValues, "boolean", ""), "");
            }
            if (filterAllowPartial !== undefined) {
                requestContext.setQueryParam("filter[allow_partial]", ObjectSerializer_1.ObjectSerializer.serialize(filterAllowPartial, "boolean", ""), "");
            }
            if (pageLimit !== undefined) {
    ...
    listVolumesByMetricName(metricName, windowSeconds, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // verify required parameter 'metricName' is not null or undefined
            if (metricName === null || metricName === undefined) {
    ...
    reorderTagIndexingRules(body, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            logger_1.logger.warn("Using unstable operation 'reorderTagIndexingRules'");
            ...
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new baseapi_1.RequiredError("body", "reorderTagIndexingRules");
            }
            // Path Params
            ...
            requestContext.setHeaderParam("Content-Type", contentType);
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(body, "TagIndexingRuleOrderRequest", ""), contentType);
            requestContext.setBody(serializedBody);
            // Apply auth methods
            (0, configuration_1.applySecurityAuthentication)(_config, requestContext, [
                "apiKeyAuth",
    ...
    updateTagIndexingRule(id, body, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            logger_1.logger.warn("Using unstable operation 'updateTagIndexingRule'");
            ...
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new baseapi_1.RequiredError("id", "updateTagIndexingRule");
            }
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new baseapi_1.RequiredError("body", "updateTagIndexingRule");
            }
            // Path Params
            const localVarPath = "/api/v2/metrics/tag-indexing-rules/{id}".replace("{id}", encodeURIComponent(String(id)));
            // Make Request Context
            ...
            requestContext.setHeaderParam("Content-Type", contentType);
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(body, "TagIndexingRuleUpdateRequest", ""), contentType);
            requestContext.setBody(serializedBody);
            // Apply auth methods
            (0, configuration_1.applySecurityAuthentication)(_config, requestContext, [
                "apiKeyAuth",
...
class MetricsApiResponseProcessor {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    createHistoricalMetricsConfiguration(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200 || response.httpStatusCode === 201) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "HistoricalMetricsConfigurationResponse");
                return body;
            }
            if (response.httpStatusCode === 400 ||
                response.httpStatusCode === 404 ||
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    createTagIndexingRule(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 201) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "TagIndexingRuleResponse");
                return body;
            }
            if (response.httpStatusCode === 400 ||
                response.httpStatusCode === 403 ||
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    createTagIndexingRuleExemption(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 201) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "TagIndexingRuleExemptionResponse");
                return body;
            }
            if (response.httpStatusCode === 400 ||
                response.httpStatusCode === 403 ||
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    deleteHistoricalMetricsConfiguration(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    deleteTagIndexingRule(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 204) {
                return;
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    deleteTagIndexingRuleExemption(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 204) {
                return;
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    getHistoricalMetricsConfiguration(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "HistoricalMetricsConfigurationResponse");
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    getMetricTagCardinalityDetails(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "MetricTagCardinalitiesResponse");
                return body;
            }
            if (response.httpStatusCode === 400 ||
                response.httpStatusCode === 403 ||
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    getTagIndexingRuleExemption(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "TagIndexingRuleExemptionResponse");
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    listTagIndexingRules(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "TagIndexingRulesResponse");
                return body;
            }
            if (response.httpStatusCode === 400 ||
                response.httpStatusCode === 403 ||
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    listTagIndexingRulesForMetric(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "TagIndexingRulesResponse");
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    reorderTagIndexingRules(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 204) {
                return;
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    updateTagIndexingRule(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "TagIndexingRuleResponse");
...
class MetricsApi {
     ...
     * @param param The request object
     */
    createHistoricalMetricsConfiguration(param, options) {
        const requestContextPromise = this.requestFactory.createHistoricalMetricsConfiguration(param.body, options);
        return requestContextPromise.then((requestContext) => {
            return this.configuration.httpApi
                .send(requestContext)
                .then((responseContext) => {
                return this.responseProcessor.createHistoricalMetricsConfiguration(responseContext);
            });
        });
    }
    /**
     ...
     * @param param The request object
     */
    createTagIndexingRule(param, options) {
     ...
     * @param param The request object
     */
    createTagIndexingRuleExemption(param, options) {
     ...
     * @param param The request object
     */
    deleteHistoricalMetricsConfiguration(param, options) {
        const requestContextPromise = this.requestFactory.deleteHistoricalMetricsConfiguration(param.metricName, options);
        return requestContextPromise.then((requestContext) => {
            return this.configuration.httpApi
                .send(requestContext)
                .then((responseContext) => {
                return this.responseProcessor.deleteHistoricalMetricsConfiguration(responseContext);
            });
        });
    }
    /**
     ...
     * @param param The request object
     */
    deleteTagIndexingRule(param, options) {
     ...
     * @param param The request object
     */
    deleteTagIndexingRuleExemption(param, options) {
     ...
     * @param param The request object
     */
    getHistoricalMetricsConfiguration(param, options) {
        const requestContextPromise = this.requestFactory.getHistoricalMetricsConfiguration(param.metricName, options);
        return requestContextPromise.then((requestContext) => {
            return this.configuration.httpApi
                .send(requestContext)
                .then((responseContext) => {
                return this.responseProcessor.getHistoricalMetricsConfiguration(responseContext);
            });
        });
    }
    /**
     ...
     * @param param The request object
     */
    getMetricTagCardinalityDetails(param, options) {
     ...
     * @param param The request object
     */
    getTagIndexingRule(param, options) {
     ...
     * @param param The request object
     */
    getTagIndexingRuleExemption(param, options) {
    ...
    listTagConfigurationsWithPagination(param = {}, options) {
        return __asyncGenerator(this, arguments, function* listTagConfigurationsWithPagination_1() {
            ...
            while (true) {
                const requestContext = yield __await(this.requestFactory.listTagConfigurations(param.filterConfigured, param.filterIsConfigurable, param.filterTagsConfigured, param.filterMetricType, param.filterIncludePercentiles, param.filterQueried, param.filterQueriedWindowSeconds, param.filterTags, param.filterRelatedAssets, param.include, param.sort, param.windowSeconds, param.pageSize, param.pageCursor, options));
     ...
     * @param param The request object
     */
    listTagIndexingRules(param = {}, options) {
     ...
     * @param param The request object
     */
    listTagIndexingRulesForMetric(param, options) {
     ...
     * @param param The request object
     */
    reorderTagIndexingRules(param, options) {
     ...
     * @param param The request object
     */
    updateTagIndexingRule(param, options) {
