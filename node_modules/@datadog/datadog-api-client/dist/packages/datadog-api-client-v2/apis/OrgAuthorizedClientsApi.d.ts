...
export declare class OrgAuthorizedClientsApiRequestFactory extends BaseAPIRequestFactory {
    deleteOrgAuthorizedClient(orgAuthorizedClientId: string, _options?: Configuration): Promise<RequestContext>;
    deleteOrgAuthorizedClientAllUserAuthorizations(orgAuthorizedClientId: string, userId: string, _options?: Configuration): Promise<RequestContext>;
    deleteOrgAuthorizedClientUserAuthorization(orgAuthorizedClientId: string, userAuthorizedClientId: string, _options?: Configuration): Promise<RequestContext>;
    getOrgAuthorizedClient(orgAuthorizedClientId: string, include?: string, filterUserAuthorizedClientsDisabled?: string, filterUserAuthorizedClientsUserDisabled?: string, _options?: Configuration): Promise<RequestContext>;
    listOrgAuthorizedClients(pageSize?: number, pageNumber?: number, sort?: string, filter?: string, filterOauth2ClientName?: string, filterDisabled?: string, include?: string, _options?: Configuration): Promise<RequestContext>;
    listOrgAuthorizedClientUserAuthorizations(orgAuthorizedClientId: string, pageSize?: number, pageNumber?: number, sort?: OrgAuthorizedClientUserAuthorizationsSort, filterDisabled?: string, filterUserName?: string, filterUserEmail?: string, filterUserDisabled?: string, _options?: Configuration): Promise<RequestContext>;
    updateOrgAuthorizedClient(orgAuthorizedClientId: string, body: OrgAuthorizedClientUpdateRequest, _options?: Configuration): Promise<RequestContext>;
}
export declare class OrgAuthorizedClientsApiResponseProcessor {
    /**
     ...
     */
    deleteOrgAuthorizedClient(response: ResponseContext): Promise<void>;
    /**
     * Unwraps the actual response sent by the server from the response context and deserializes the response content
     * to the expected objects
     *
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    deleteOrgAuthorizedClientAllUserAuthorizations(response: ResponseContext): Promise<void>;
    /**
     * Unwraps the actual response sent by the server from the response context and deserializes the response content
     * to the expected objects
     *
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    deleteOrgAuthorizedClientUserAuthorization(response: ResponseContext): Promise<void>;
    /**
     * Unwraps the actual response sent by the server from the response context and deserializes the response content
     * to the expected objects
     *
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    getOrgAuthorizedClient(response: ResponseContext): Promise<OrgAuthorizedClientResponse>;
    /**
     * Unwraps the actual response sent by the server from the response context and deserializes the response content
     * to the expected objects
     *
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    listOrgAuthorizedClients(response: ResponseContext): Promise<OrgAuthorizedClientsResponse>;
    /**
     * Unwraps the actual response sent by the server from the response context and deserializes the response content
     * to the expected objects
     *
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    listOrgAuthorizedClientUserAuthorizations(response: ResponseContext): Promise<UserAuthorizedClientsResponse>;
    /**
     * Unwraps the actual response sent by the server from the response context and deserializes the response content
     * to the expected objects
     *
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    updateOrgAuthorizedClient(response: ResponseContext): Promise<OrgAuthorizedClientResponse>;
}
...
export declare class OrgAuthorizedClientsApi {
    private requestFactory;
    private responseProcessor;
    private configuration;
    constructor(configuration: Configuration, requestFactory?: OrgAuthorizedClientsApiRequestFactory, responseProcessor?: OrgAuthorizedClientsApiResponseProcessor);
    /**
     * Disable an OAuth2 client authorization for the current organization, revoking access for all users.
     * @param param The request object
     */
    deleteOrgAuthorizedClient(param: OrgAuthorizedClientsApiDeleteOrgAuthorizedClientRequest, options?: Configuration): Promise<void>;
    /**
     * Disable all authorizations for a specific user for the specified OAuth2 client in the current organization.
     * @param param The request object
     */
    deleteOrgAuthorizedClientAllUserAuthorizations(param: OrgAuthorizedClientsApiDeleteOrgAuthorizedClientAllUserAuthorizationsRequest, options?: Configuration): Promise<void>;
    /**
     * Disable a specific user authorization for the specified OAuth2 client in the current organization.
     * @param param The request object
     */
    deleteOrgAuthorizedClientUserAuthorization(param: OrgAuthorizedClientsApiDeleteOrgAuthorizedClientUserAuthorizationRequest, options?: Configuration): Promise<void>;
    /**
     * Get a single OAuth2 client authorized for the current organization.
     * @param param The request object
     */
    getOrgAuthorizedClient(param: OrgAuthorizedClientsApiGetOrgAuthorizedClientRequest, options?: Configuration): Promise<OrgAuthorizedClientResponse>;
    /**
     * Get a list of all OAuth2 clients authorized for the current organization.
     * @param param The request object
     */
    listOrgAuthorizedClients(param?: OrgAuthorizedClientsApiListOrgAuthorizedClientsRequest, options?: Configuration): Promise<OrgAuthorizedClientsResponse>;
    /**
     * Provide a paginated version of listOrgAuthorizedClients returning a generator with all the items.
     */
    listOrgAuthorizedClientsWithPagination(param?: OrgAuthorizedClientsApiListOrgAuthorizedClientsRequest, options?: Configuration): AsyncGenerator<OrgAuthorizedClientData>;
    /**
     * Get a list of user authorizations for the specified OAuth2 client in the current organization.
     * @param param The request object
     */
    listOrgAuthorizedClientUserAuthorizations(param: OrgAuthorizedClientsApiListOrgAuthorizedClientUserAuthorizationsRequest, options?: Configuration): Promise<UserAuthorizedClientsResponse>;
    /**
     * Provide a paginated version of listOrgAuthorizedClientUserAuthorizations returning a generator with all the items.
     */
    listOrgAuthorizedClientUserAuthorizationsWithPagination(param: OrgAuthorizedClientsApiListOrgAuthorizedClientUserAuthorizationsRequest, options?: Configuration): AsyncGenerator<UserAuthorizedClientData>;
    /**
     * Enable or disable an OAuth2 client authorization for the current organization.
     * @param param The request object
     */
    updateOrgAuthorizedClient(param: OrgAuthorizedClientsApiUpdateOrgAuthorizedClientRequest, options?: Configuration): Promise<OrgAuthorizedClientResponse>;
}
