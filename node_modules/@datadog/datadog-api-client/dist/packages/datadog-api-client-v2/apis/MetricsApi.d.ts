...
export declare class MetricsApiRequestFactory extends BaseAPIRequestFactory {
    ...
    createHistoricalMetricsConfiguration(body: HistoricalMetricsConfigurationCreateRequest, _options?: Configuration): Promise<RequestContext>;
    ...
    deleteHistoricalMetricsConfiguration(metricName: string, _options?: Configuration): Promise<RequestContext>;
    ...
    getHistoricalMetricsConfiguration(metricName: string, _options?: Configuration): Promise<RequestContext>;
...
export declare class MetricsApiResponseProcessor {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    createHistoricalMetricsConfiguration(response: ResponseContext): Promise<HistoricalMetricsConfigurationResponse>;
    /**
     * Unwraps the actual response sent by the server from the response context and deserializes the response content
     * to the expected objects
     *
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    deleteHistoricalMetricsConfiguration(response: ResponseContext): Promise<void>;
    /**
     * Unwraps the actual response sent by the server from the response context and deserializes the response content
     * to the expected objects
     *
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    getHistoricalMetricsConfiguration(response: ResponseContext): Promise<HistoricalMetricsConfigurationResponse>;
    /**
     * Unwraps the actual response sent by the server from the response context and deserializes the response content
     * to the expected objects
     *
...
export declare class MetricsApi {
     ...
     * @param param The request object
     */
    createHistoricalMetricsConfiguration(param: MetricsApiCreateHistoricalMetricsConfigurationRequest, options?: Configuration): Promise<HistoricalMetricsConfigurationResponse>;
    /**
     ...
     * @param param The request object
     */
    deleteHistoricalMetricsConfiguration(param: MetricsApiDeleteHistoricalMetricsConfigurationRequest, options?: Configuration): Promise<void>;
    /**
     ...
     * @param param The request object
     */
    getHistoricalMetricsConfiguration(param: MetricsApiGetHistoricalMetricsConfigurationRequest, options?: Configuration): Promise<HistoricalMetricsConfigurationResponse>;
    /**
