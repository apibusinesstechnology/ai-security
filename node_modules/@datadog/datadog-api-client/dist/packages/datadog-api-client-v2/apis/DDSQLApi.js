...
exports.DDSQLApi = exports.DDSQLApiResponseProcessor = exports.DDSQLApiRequestFactory = void 0;
...
class DDSQLApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    executeDdsqlTabularQuery(body, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new baseapi_1.RequiredError("body", "executeDdsqlTabularQuery");
            }
            // Path Params
            ...
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(body, "DdsqlTabularQueryRequest", ""), contentType);
    ...
    fetchDdsqlTabularQuery(body, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new baseapi_1.RequiredError("body", "fetchDdsqlTabularQuery");
            }
            // Path Params
            ...
            requestContext.setHeaderParam("Content-Type", contentType);
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(body, "DdsqlTabularQueryFetchRequest", ""), contentType);
            requestContext.setBody(serializedBody);
            // Apply auth methods
            (0, configuration_1.applySecurityAuthentication)(_config, requestContext, [
                "apiKeyAuth",
...
exports.DDSQLApiRequestFactory = DDSQLApiRequestFactory;
class DDSQLApiResponseProcessor {
    /**
     ...
     */
    executeDdsqlTabularQuery(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "DdsqlTabularQueryResponse");
                return body;
            }
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    fetchDdsqlTabularQuery(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "DdsqlTabularQueryResponse");
...
exports.DDSQLApiResponseProcessor = DDSQLApiResponseProcessor;
class DDSQLApi {
     ...
     */
    executeDdsqlTabularQuery(param, options) {
     ...
     * @param param The request object
     */
    fetchDdsqlTabularQuery(param, options) {
...
exports.DDSQLApi = DDSQLApi;
//# sourceMappingURL=DDSQLApi.js.map