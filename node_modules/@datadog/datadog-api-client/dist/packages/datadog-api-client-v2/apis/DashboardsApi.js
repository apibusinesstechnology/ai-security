...
class DashboardsApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    getDashboardUsage(dashboardId, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            logger_1.logger.warn("Using unstable operation 'getDashboardUsage'");
            ...
            if (dashboardId === null || dashboardId === undefined) {
                throw new baseapi_1.RequiredError("dashboardId", "getDashboardUsage");
            }
            // Path Params
            const localVarPath = "/api/v2/dashboards/{dashboard_id}/usage".replace("{dashboard_id}", encodeURIComponent(String(dashboardId)));
    ...
    listDashboardsUsage(pageLimit, pageOffset, filterEditedBefore, filterViewedBefore, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            logger_1.logger.warn("Using unstable operation 'listDashboardsUsage'");
            ...
            if (filterEditedBefore !== undefined) {
                requestContext.setQueryParam("filter[edited_before]", ObjectSerializer_1.ObjectSerializer.serialize(filterEditedBefore, "string", ""), "");
            }
            if (filterViewedBefore !== undefined) {
                requestContext.setQueryParam("filter[viewed_before]", ObjectSerializer_1.ObjectSerializer.serialize(filterViewedBefore, "string", ""), "");
            }
            // Apply auth methods
            (0, configuration_1.applySecurityAuthentication)(_config, requestContext, [
                "apiKeyAuth",
...
class DashboardsApiResponseProcessor {
     ...
     */
    getDashboardUsage(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "DashboardUsageResponse");
                return body;
            }
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    listDashboardsUsage(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "ListDashboardsUsageResponse");
                return body;
            }
            if (response.httpStatusCode === 400 ||
                response.httpStatusCode === 403 ||
...
class DashboardsApi {
     ...
     */
    getDashboardUsage(param, options) {
     ...
     * @param param The request object
     */
    listDashboardsUsage(param = {}, options) {
     ...
     */
    listDashboardsUsageWithPagination(param = {}, options) {
        return __asyncGenerator(this, arguments, function* listDashboardsUsageWithPagination_1() {
            let pageSize = 250;
            ...
            while (true) {
                const requestContext = yield __await(this.requestFactory.listDashboardsUsage(param.pageLimit, param.pageOffset, param.filterEditedBefore, param.filterViewedBefore, options));
                const responseContext = yield __await(this.configuration.httpApi.send(requestContext));
                const response = yield __await(this.responseProcessor.listDashboardsUsage(responseContext));
