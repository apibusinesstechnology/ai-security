...
exports.IdentityProvidersApi = exports.IdentityProvidersApiResponseProcessor = exports.IdentityProvidersApiRequestFactory = void 0;
...
class IdentityProvidersApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    listIdentityProviders(_options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const requestContext = _config
                .getServer("v2.IdentityProvidersApi.listIdentityProviders")
    ...
    listIdentityProviderUsers(idpId, pageSize, pageNumber, sort, sortDir, filter, filterStatus, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // verify required parameter 'idpId' is not null or undefined
            if (idpId === null || idpId === undefined) {
                throw new baseapi_1.RequiredError("idpId", "listIdentityProviderUsers");
            }
            // Path Params
            const localVarPath = "/api/v2/identity_providers/{idp_id}/users".replace("{idp_id}", encodeURIComponent(String(idpId)));
            // Make Request Context
            const requestContext = _config
                .getServer("v2.IdentityProvidersApi.listIdentityProviderUsers")
                .makeRequestContext(localVarPath, http_1.HttpMethod.GET);
            requestContext.setHeaderParam("Accept", "application/json");
            requestContext.setHttpConfig(_config.httpConfig);
            // Query Params
    ...
    updateIdentityProvider(idpId, body, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // verify required parameter 'idpId' is not null or undefined
            if (idpId === null || idpId === undefined) {
                throw new baseapi_1.RequiredError("idpId", "updateIdentityProvider");
            }
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new baseapi_1.RequiredError("body", "updateIdentityProvider");
            }
            // Path Params
            const localVarPath = "/api/v2/identity_providers/{idp_id}".replace("{idp_id}", encodeURIComponent(String(idpId)));
            // Make Request Context
            const requestContext = _config
                .getServer("v2.IdentityProvidersApi.updateIdentityProvider")
            ...
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(body, "IdentityProviderUpdateRequest", ""), contentType);
...
exports.IdentityProvidersApiRequestFactory = IdentityProvidersApiRequestFactory;
class IdentityProvidersApiResponseProcessor {
    /**
    ...
    listIdentityProviders(response) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "IdentityProvidersResponse");
                return body;
            }
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    listIdentityProviderUsers(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    updateIdentityProvider(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "IdentityProviderResponse");
                return body;
            }
            if (response.httpStatusCode === 400 ||
                response.httpStatusCode === 403 ||
...
exports.IdentityProvidersApiResponseProcessor = IdentityProvidersApiResponseProcessor;
class IdentityProvidersApi {
    constructor(configuration, requestFactory, responseProcessor) {
        this.configuration = configuration;
        this.requestFactory =
            requestFactory || new IdentityProvidersApiRequestFactory(configuration);
     ...
     * @param param The request object
     */
    listIdentityProviderUsers(param, options) {
     ...
     */
    listIdentityProviderUsersWithPagination(param, options) {
        return __asyncGenerator(this, arguments, function* listIdentityProviderUsersWithPagination_1() {
            let pageSize = 10;
            ...
            param.pageNumber = 0;
            while (true) {
                const requestContext = yield __await(this.requestFactory.listIdentityProviderUsers(param.idpId, param.pageSize, param.pageNumber, param.sort, param.sortDir, param.filter, param.filterStatus, options));
                const responseContext = yield __await(this.configuration.httpApi.send(requestContext));
                const response = yield __await(this.responseProcessor.listIdentityProviderUsers(responseContext));
...
exports.IdentityProvidersApi = IdentityProvidersApi;
//# sourceMappingURL=IdentityProvidersApi.js.map