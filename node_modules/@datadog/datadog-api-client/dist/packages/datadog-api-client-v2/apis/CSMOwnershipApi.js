...
class CSMOwnershipApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    ...
    getOwnershipSettings(_options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            logger_1.logger.warn("Using unstable operation 'getOwnershipSettings'");
    ...
    getOwnershipUntaggedFindings(_options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            logger_1.logger.warn("Using unstable operation 'getOwnershipUntaggedFindings'");
            if (!_config.unstableOperations["v2.getOwnershipUntaggedFindings"]) {
                throw new Error("Unstable operation 'getOwnershipUntaggedFindings' is disabled");
            }
            // Path Params
    ...
    postOwnershipSettings(body, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            logger_1.logger.warn("Using unstable operation 'postOwnershipSettings'");
            ...
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new baseapi_1.RequiredError("body", "postOwnershipSettings");
            }
            // Path Params
            const localVarPath = "/api/v2/csm/ownership/settings";
            // Make Request Context
            ...
            requestContext.setHeaderParam("Content-Type", contentType);
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(body, "OwnershipSettingsRequest", ""), contentType);
            requestContext.setBody(serializedBody);
            // Apply auth methods
            (0, configuration_1.applySecurityAuthentication)(_config, requestContext, [
                "apiKeyAuth",
...
class CSMOwnershipApiResponseProcessor {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    getOwnershipSettings(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "OwnershipSettingsResponse");
                return body;
            }
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    getOwnershipUntaggedFindings(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "OwnershipUntaggedFindingsResponse");
                return body;
            }
            if (response.httpStatusCode === 401) {
                const bodyText = ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType);
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    postOwnershipSettings(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "OwnershipSettingsResponse");
...
class CSMOwnershipApi {
     ...
     * @param param The request object
     */
    getOwnershipSettings(options) {
        const requestContextPromise = this.requestFactory.getOwnershipSettings(options);
        return requestContextPromise.then((requestContext) => {
            return this.configuration.httpApi
                .send(requestContext)
                .then((responseContext) => {
     ...
     * @param param The request object
     */
    getOwnershipUntaggedFindings(options) {
        const requestContextPromise = this.requestFactory.getOwnershipUntaggedFindings(options);
        return requestContextPromise.then((requestContext) => {
            return this.configuration.httpApi
                .send(requestContext)
                .then((responseContext) => {
                return this.responseProcessor.getOwnershipUntaggedFindings(responseContext);
            });
        });
    }
    /**
     ...
     * @param param The request object
     */
    postOwnershipSettings(param, options) {
        const requestContextPromise = this.requestFactory.postOwnershipSettings(param.body, options);
        return requestContextPromise.then((requestContext) => {
            return this.configuration.httpApi
                .send(requestContext)
                .then((responseContext) => {
