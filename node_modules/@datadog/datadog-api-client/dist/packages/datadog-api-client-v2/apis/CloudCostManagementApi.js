...
class CloudCostManagementApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    ...
    createCustomAllocationRule(body, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new baseapi_1.RequiredError("body", "createCustomAllocationRule");
            }
            // Path Params
    ...
    createTagPipelinesRuleset(body, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new baseapi_1.RequiredError("body", "createTagPipelinesRuleset");
            }
            // Path Params
    ...
    deleteCostTagDescriptionByKey(tagKey, cloud, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // verify required parameter 'tagKey' is not null or undefined
            if (tagKey === null || tagKey === undefined) {
                throw new baseapi_1.RequiredError("tagKey", "deleteCostTagDescriptionByKey");
            }
            // Path Params
            const localVarPath = "/api/v2/cost/tag_descriptions/{tag_key}".replace("{tag_key}", encodeURIComponent(String(tagKey)));
            // Make Request Context
            const requestContext = _config
            ...
            // Query Params
            if (cloud !== undefined) {
                requestContext.setQueryParam("cloud", ObjectSerializer_1.ObjectSerializer.serialize(cloud, "string", ""), "");
            }
            // Apply auth methods
            (0, configuration_1.applySecurityAuthentication)(_config, requestContext, [
                "apiKeyAuth",
    ...
    deleteCustomAllocationRule(ruleId, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // verify required parameter 'ruleId' is not null or undefined
            if (ruleId === null || ruleId === undefined) {
                throw new baseapi_1.RequiredError("ruleId", "deleteCustomAllocationRule");
            }
            // Path Params
    ...
    deleteCustomForecast(budgetId, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // verify required parameter 'budgetId' is not null or undefined
            if (budgetId === null || budgetId === undefined) {
                throw new baseapi_1.RequiredError("budgetId", "deleteCustomForecast");
            }
            // Path Params
            const localVarPath = "/api/v2/cost/budget/{budget_id}/custom-forecast".replace("{budget_id}", encodeURIComponent(String(budgetId)));
            // Make Request Context
            const requestContext = _config
    ...
    deleteTagPipelinesRuleset(rulesetId, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // verify required parameter 'rulesetId' is not null or undefined
            if (rulesetId === null || rulesetId === undefined) {
                throw new baseapi_1.RequiredError("rulesetId", "deleteTagPipelinesRuleset");
            }
            // Path Params
    ...
    generateCostTagDescriptionByKey(tagKey, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // verify required parameter 'tagKey' is not null or undefined
            if (tagKey === null || tagKey === undefined) {
                throw new baseapi_1.RequiredError("tagKey", "generateCostTagDescriptionByKey");
            }
            // Path Params
            const localVarPath = "/api/v2/cost/tag_descriptions/{tag_key}/generate".replace("{tag_key}", encodeURIComponent(String(tagKey)));
            // Make Request Context
            const requestContext = _config
    ...
    getBudget(budgetId, actual, forecast, start, end, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // verify required parameter 'budgetId' is not null or undefined
            if (budgetId === null || budgetId === undefined) {
            ...
            // Query Params
            if (actual !== undefined) {
                requestContext.setQueryParam("actual", ObjectSerializer_1.ObjectSerializer.serialize(actual, "boolean", ""), "");
            }
            if (forecast !== undefined) {
                requestContext.setQueryParam("forecast", ObjectSerializer_1.ObjectSerializer.serialize(forecast, "boolean", ""), "");
            }
            if (start !== undefined) {
    ...
    getCostAccountFilters(cloudAccountId, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // verify required parameter 'cloudAccountId' is not null or undefined
            if (cloudAccountId === null || cloudAccountId === undefined) {
                throw new baseapi_1.RequiredError("cloudAccountId", "getCostAccountFilters");
            }
            // Path Params
            const localVarPath = "/api/v2/cost/account_filters/{cloud_account_id}".replace("{cloud_account_id}", encodeURIComponent(String(cloudAccountId)));
            // Make Request Context
            const requestContext = _config
    ...
    getCostTagDescriptionByKey(tagKey, filterCloud, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // verify required parameter 'tagKey' is not null or undefined
            if (tagKey === null || tagKey === undefined) {
                throw new baseapi_1.RequiredError("tagKey", "getCostTagDescriptionByKey");
            }
            // Path Params
            const localVarPath = "/api/v2/cost/tag_descriptions/{tag_key}".replace("{tag_key}", encodeURIComponent(String(tagKey)));
            // Make Request Context
    ...
    getCostTagMetadataCurrency(filterMonth, filterProvider, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            logger_1.logger.warn("Using unstable operation 'getCostTagMetadataCurrency'");
            ...
            if (filterMonth === null || filterMonth === undefined) {
                throw new baseapi_1.RequiredError("filterMonth", "getCostTagMetadataCurrency");
            }
            // Path Params
            ...
            if (filterMonth !== undefined) {
                requestContext.setQueryParam("filter[month]", ObjectSerializer_1.ObjectSerializer.serialize(filterMonth, "string", ""), "");
            }
            if (filterProvider !== undefined) {
                requestContext.setQueryParam("filter[provider]", ObjectSerializer_1.ObjectSerializer.serialize(filterProvider, "string", ""), "");
            }
            // Apply auth methods
            (0, configuration_1.applySecurityAuthentication)(_config, requestContext, [
                "apiKeyAuth",
    ...
    getCustomForecast(budgetId, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // verify required parameter 'budgetId' is not null or undefined
            if (budgetId === null || budgetId === undefined) {
                throw new baseapi_1.RequiredError("budgetId", "getCustomForecast");
            }
            // Path Params
            const localVarPath = "/api/v2/cost/budget/{budget_id}/custom-forecast".replace("{budget_id}", encodeURIComponent(String(budgetId)));
            // Make Request Context
    ...
    listCostTagKeySources(filterMonth, filterProvider, filterMetric, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            logger_1.logger.warn("Using unstable operation 'listCostTagKeySources'");
            ...
            // verify required parameter 'filterMonth' is not null or undefined
            if (filterMonth === null || filterMonth === undefined) {
                throw new baseapi_1.RequiredError("filterMonth", "listCostTagKeySources");
            }
            // Path Params
    ...
    listCostTagMetadata(filterMonth, filterProvider, filterMetric, filterTagKey, filterDaily, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            logger_1.logger.warn("Using unstable operation 'listCostTagMetadata'");
            if (!_config.unstableOperations["v2.listCostTagMetadata"]) {
                throw new Error("Unstable operation 'listCostTagMetadata' is disabled");
            }
            // verify required parameter 'filterMonth' is not null or undefined
            if (filterMonth === null || filterMonth === undefined) {
                throw new baseapi_1.RequiredError("filterMonth", "listCostTagMetadata");
            }
            // Path Params
            ...
            if (filterTagKey !== undefined) {
                requestContext.setQueryParam("filter[tag_key]", ObjectSerializer_1.ObjectSerializer.serialize(filterTagKey, "string", ""), "");
            }
            if (filterDaily !== undefined) {
                requestContext.setQueryParam("filter[daily]", ObjectSerializer_1.ObjectSerializer.serialize(filterDaily, "CostTagMetadataDailyFilter", ""), "");
            }
            // Apply auth methods
            (0, configuration_1.applySecurityAuthentication)(_config, requestContext, [
                "apiKeyAuth",
    ...
    listCostTagMetadataMetrics(filterMonth, filterProvider, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            logger_1.logger.warn("Using unstable operation 'listCostTagMetadataMetrics'");
            ...
            // verify required parameter 'filterMonth' is not null or undefined
            if (filterMonth === null || filterMonth === undefined) {
                throw new baseapi_1.RequiredError("filterMonth", "listCostTagMetadataMetrics");
            }
            // Path Params
    ...
    listCostTagMetadataMonths(filterProvider, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            logger_1.logger.warn("Using unstable operation 'listCostTagMetadataMonths'");
            ...
            if (filterProvider === null || filterProvider === undefined) {
                throw new baseapi_1.RequiredError("filterProvider", "listCostTagMetadataMonths");
            }
            // Path Params
    ...
    listCostTagMetadataOrchestrators(filterMonth, filterProvider, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            logger_1.logger.warn("Using unstable operation 'listCostTagMetadataOrchestrators'");
            ...
            // verify required parameter 'filterMonth' is not null or undefined
            if (filterMonth === null || filterMonth === undefined) {
                throw new baseapi_1.RequiredError("filterMonth", "listCostTagMetadataOrchestrators");
            }
            // Path Params
    ...
    searchCostRecommendations(body, pageSize, pageToken, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            logger_1.logger.warn("Using unstable operation 'searchCostRecommendations'");
            ...
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new baseapi_1.RequiredError("body", "searchCostRecommendations");
            }
            // Path Params
            ...
            // Query Params
            if (pageSize !== undefined) {
                requestContext.setQueryParam("page[size]", ObjectSerializer_1.ObjectSerializer.serialize(pageSize, "string", ""), "");
            }
            ...
            requestContext.setHeaderParam("Content-Type", contentType);
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(body, "RecommendationsFilterRequest", ""), contentType);
            requestContext.setBody(serializedBody);
            // Apply auth methods
            (0, configuration_1.applySecurityAuthentication)(_config, requestContext, [
                "apiKeyAuth",
    ...
    updateCostAccountFilters(cloudAccountId, body, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // verify required parameter 'cloudAccountId' is not null or undefined
            if (cloudAccountId === null || cloudAccountId === undefined) {
                throw new baseapi_1.RequiredError("cloudAccountId", "updateCostAccountFilters");
            }
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new baseapi_1.RequiredError("body", "updateCostAccountFilters");
            }
            // Path Params
            const localVarPath = "/api/v2/cost/account_filters/{cloud_account_id}".replace("{cloud_account_id}", encodeURIComponent(String(cloudAccountId)));
            // Make Request Context
            ...
            requestContext.setHeaderParam("Content-Type", contentType);
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(body, "AccountFiltersPatchRequest", ""), contentType);
            requestContext.setBody(serializedBody);
            // Apply auth methods
            (0, configuration_1.applySecurityAuthentication)(_config, requestContext, [
                "apiKeyAuth",
    ...
    upsertCostTagDescriptionByKey(tagKey, body, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // verify required parameter 'tagKey' is not null or undefined
            if (tagKey === null || tagKey === undefined) {
                throw new baseapi_1.RequiredError("tagKey", "upsertCostTagDescriptionByKey");
            }
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new baseapi_1.RequiredError("body", "upsertCostTagDescriptionByKey");
            }
            // Path Params
            const localVarPath = "/api/v2/cost/tag_descriptions/{tag_key}".replace("{tag_key}", encodeURIComponent(String(tagKey)));
            // Make Request Context
            ...
            requestContext.setHeaderParam("Content-Type", contentType);
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(body, "CostTagDescriptionUpsertRequest", ""), contentType);
            requestContext.setBody(serializedBody);
            // Apply auth methods
            (0, configuration_1.applySecurityAuthentication)(_config, requestContext, [
                "apiKeyAuth",
    ...
    upsertCustomForecast(body, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new baseapi_1.RequiredError("body", "upsertCustomForecast");
            }
            // Path Params
            ...
            requestContext.setHeaderParam("Content-Type", contentType);
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(body, "CustomForecastUpsertRequest", ""), contentType);
            requestContext.setBody(serializedBody);
            // Apply auth methods
            (0, configuration_1.applySecurityAuthentication)(_config, requestContext, [
                "apiKeyAuth",
...
class CloudCostManagementApiResponseProcessor {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    deleteCostTagDescriptionByKey(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 204) {
                return;
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    generateCostTagDescriptionByKey(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "GenerateCostTagDescriptionResponse");
                return body;
            }
            if (response.httpStatusCode === 400 ||
                response.httpStatusCode === 403 ||
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    getCostAccountFilters(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "AccountFiltersResponse");
                return body;
            }
            if (response.httpStatusCode === 400 ||
                response.httpStatusCode === 403 ||
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    getCostTagDescriptionByKey(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "CostTagDescriptionResponse");
                return body;
            }
            if (response.httpStatusCode === 400 ||
                response.httpStatusCode === 403 ||
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    getCostTagMetadataCurrency(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "CostCurrencyResponse");
                return body;
            }
            if (response.httpStatusCode === 400 ||
                response.httpStatusCode === 403 ||
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    getCustomForecast(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "CustomForecastResponse");
                return body;
            }
            if (response.httpStatusCode === 400 ||
                response.httpStatusCode === 404 ||
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    listCostTagKeySources(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "CostTagKeySourcesResponse");
                return body;
            }
            if (response.httpStatusCode === 400 ||
                response.httpStatusCode === 403 ||
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    listCostTagMetadata(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "CostTagKeyMetadataResponse");
                return body;
            }
            if (response.httpStatusCode === 400 ||
                response.httpStatusCode === 403 ||
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    listCostTagMetadataMetrics(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "CostMetricsResponse");
                return body;
            }
            if (response.httpStatusCode === 400 ||
                response.httpStatusCode === 403 ||
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    listCostTagMetadataMonths(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "CostTagMetadataMonthsResponse");
                return body;
            }
            if (response.httpStatusCode === 400 ||
                response.httpStatusCode === 403 ||
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    listCostTagMetadataOrchestrators(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "CostOrchestratorsResponse");
                return body;
            }
            if (response.httpStatusCode === 400 ||
                response.httpStatusCode === 403 ||
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    reorderCustomAllocationRules(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 204) {
                return;
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    reorderTagPipelinesRulesets(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 204) {
                return;
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    searchCostRecommendations(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "CostRecommendationArray");
                return body;
            }
            if (response.httpStatusCode === 429) {
                const bodyText = ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType);
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    updateCostAccountFilters(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "AccountFiltersResponse");
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    updateCustomAllocationRule(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "ArbitraryRuleResponse");
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    updateTagPipelinesRuleset(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "RulesetResp");
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    upsertCostTagDescriptionByKey(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 204) {
                return;
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    validateBudget(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "BudgetValidationResponse");
                return body;
            }
            if (response.httpStatusCode === 429) {
                const bodyText = ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType);
...
class CloudCostManagementApi {
     ...
     * @param param The request object
     */
    createTagPipelinesRuleset(param, options) {
     ...
     * @param param The request object
     */
    deleteCostTagDescriptionByKey(param, options) {
     ...
     * @param param The request object
     */
    deleteCustomAllocationRule(param, options) {
     ...
     * @param param The request object
     */
    deleteCustomForecast(param, options) {
     ...
     * @param param The request object
     */
    deleteTagPipelinesRuleset(param, options) {
     ...
     * @param param The request object
     */
    generateCostTagDescriptionByKey(param, options) {
     ...
     * @param param The request object
     */
    getCostAccountFilters(param, options) {
     ...
     * @param param The request object
     */
    getCostTagDescriptionByKey(param, options) {
     ...
     * @param param The request object
     */
    getCostTagMetadataCurrency(param, options) {
     ...
     * @param param The request object
     */
    getCustomAllocationRule(param, options) {
     ...
     * @param param The request object
     */
    getCustomForecast(param, options) {
     ...
     * @param param The request object
     */
    getTagPipelinesRuleset(param, options) {
     ...
     * @param param The request object
     */
    listCostTagKeySources(param, options) {
     ...
     * @param param The request object
     */
    listCostTagMetadata(param, options) {
     ...
     * @param param The request object
     */
    listCostTagMetadataMetrics(param, options) {
     ...
     * @param param The request object
     */
    listCostTagMetadataMonths(param, options) {
     ...
     * @param param The request object
     */
    listCostTagMetadataOrchestrators(param, options) {
     ...
     * @param param The request object
     */
    listCustomAllocationRules(options) {
     ...
     * @param param The request object
     */
    listTagPipelinesRulesets(options) {
     ...
     * @param param The request object
     */
    reorderCustomAllocationRules(param, options) {
     ...
     * @param param The request object
     */
    reorderTagPipelinesRulesets(param, options) {
     ...
     * @param param The request object
     */
    searchCostRecommendations(param, options) {
     ...
     * @param param The request object
     */
    updateCostAccountFilters(param, options) {
     ...
     * @param param The request object
     */
    updateTagPipelinesRuleset(param, options) {
     ...
     * @param param The request object
     */
    upsertCostTagDescriptionByKey(param, options) {
     ...
     * @param param The request object
     */
    upsertCustomForecast(param, options) {
