...
exports.UserAuthorizedClientsApi = exports.UserAuthorizedClientsApiResponseProcessor = exports.UserAuthorizedClientsApiRequestFactory = void 0;
...
class UserAuthorizedClientsApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    deleteUserAuthorizedClient(userAuthorizedClientId, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (userAuthorizedClientId === null ||
                ...
                throw new baseapi_1.RequiredError("userAuthorizedClientId", "deleteUserAuthorizedClient");
            }
            // Path Params
            const localVarPath = "/api/v2/user_authorized_clients/{user_authorized_client_id}".replace("{user_authorized_client_id}", encodeURIComponent(String(userAuthorizedClientId)));
    ...
    deleteUserAuthorizedClientsByClient(clientId, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // verify required parameter 'clientId' is not null or undefined
            if (clientId === null || clientId === undefined) {
                throw new baseapi_1.RequiredError("clientId", "deleteUserAuthorizedClientsByClient");
            }
            // Path Params
            const localVarPath = "/api/v2/user_authorized_clients/client/{client_id}".replace("{client_id}", encodeURIComponent(String(clientId)));
            // Make Request Context
            const requestContext = _config
                .getServer("v2.UserAuthorizedClientsApi.deleteUserAuthorizedClientsByClient")
                .makeRequestContext(localVarPath, http_1.HttpMethod.DELETE);
            requestContext.setHeaderParam("Accept", "*/*");
            requestContext.setHttpConfig(_config.httpConfig);
            // Apply auth methods
    ...
    getUserAuthorizedClient(userAuthorizedClientId, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // verify required parameter 'userAuthorizedClientId' is not null or undefined
            if (userAuthorizedClientId === null ||
                userAuthorizedClientId === undefined) {
                throw new baseapi_1.RequiredError("userAuthorizedClientId", "getUserAuthorizedClient");
            }
            // Path Params
            const localVarPath = "/api/v2/user_authorized_clients/{user_authorized_client_id}".replace("{user_authorized_client_id}", encodeURIComponent(String(userAuthorizedClientId)));
            // Make Request Context
    ...
    listUserAuthorizedClients(pageSize, pageNumber, filter, filterDisabled, include, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // Path Params
...
exports.UserAuthorizedClientsApiRequestFactory = UserAuthorizedClientsApiRequestFactory;
class UserAuthorizedClientsApiResponseProcessor {
    /**
     ...
     */
    deleteUserAuthorizedClient(response) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    deleteUserAuthorizedClientsByClient(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 204) {
                return;
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    getUserAuthorizedClient(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "UserAuthorizedClientResponse");
                return body;
            }
            if (response.httpStatusCode === 403 || response.httpStatusCode === 404) {
                const bodyText = ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType);
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    listUserAuthorizedClients(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (response.httpStatusCode === 200) {
...
exports.UserAuthorizedClientsApiResponseProcessor = UserAuthorizedClientsApiResponseProcessor;
class UserAuthorizedClientsApi {
     ...
     */
    deleteUserAuthorizedClient(param, options) {
     ...
     * @param param The request object
     */
    deleteUserAuthorizedClientsByClient(param, options) {
     ...
     * @param param The request object
     */
    getUserAuthorizedClient(param, options) {
     ...
     * @param param The request object
     */
    listUserAuthorizedClients(param = {}, options) {
     ...
     */
    listUserAuthorizedClientsWithPagination(param = {}, options) {
        return __asyncGenerator(this, arguments, function* listUserAuthorizedClientsWithPagination_1() {
            let pageSize = 10;
            ...
            param.pageNumber = 0;
            while (true) {
                const requestContext = yield __await(this.requestFactory.listUserAuthorizedClients(param.pageSize, param.pageNumber, param.filter, param.filterDisabled, param.include, options));
                const responseContext = yield __await(this.configuration.httpApi.send(requestContext));
                const response = yield __await(this.responseProcessor.listUserAuthorizedClients(responseContext));
...
exports.UserAuthorizedClientsApi = UserAuthorizedClientsApi;
//# sourceMappingURL=UserAuthorizedClientsApi.js.map